...
def banner():
    os.system('clear')
    print " "
runntxt(GL+"              Ba Sai@grayhacker. ^_^")
runntxt(WW+"  ____          ____        _")
runntxt(WW+" | __ )  __ _  / ___|  __ _(_)")
runntxt(GL+" |  _ \ / _` | \___ \ / _` | |")
runntxt(GG+" | |_) | (_| |  ___) | (_| | |")
runntxt(Y +" |____/ \__,_| |____/ \__,_|_|")
    time.sleep(1.5)
    print GG+"  √=============================================√"
...
print wd+"         https://www.github.com/BaSaiGrayHacker "
